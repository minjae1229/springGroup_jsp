...
<div class="container">
  <h2>성적 자료</h2>
  <form name="myform" method="post" action="t15_1Ok.jsp">
    ...
    <p> 사회 : <input type="number" name="sci" value="70" class="form-control" required /></p>
    <p> 과학 : <input type="number" name="soc" value="60" class="form-control" required /></p>
    <p>
